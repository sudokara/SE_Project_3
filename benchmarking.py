...
for i in range(100):
    ...
    clear_file(
        "/home/prakhar/Desktop/3-2/Software Engineering/Projects/SE_Project_3/src/phoenix/CLI/log")

    current_time = datetime.now()

    write_random_char_to_file(
        "/home/prakhar/Desktop/3-2/Software Engineering/Projects/SE_Project_3/src/phoenix/Observation/watchDir2/2")
    ...
    time_list.append((current_time - backup_time).total_seconds())
    # print(current_time)
...
np.save('/home/prakhar/Desktop/3-2/Software Engineering/Projects/SE_Project_3/time_list.npy', time_array)
